      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col gap-5 sm:flex-row items-start justify-between mb-4 ">
          ...
          <div className="flex gap-2 w-full sm:w-auto">
            ...
            <Button
              variant="outline"
              size="sm"
              onClick={() => router.push(`/events/${eventId}/simulation`)}
              className="gap-2 flex-1 cursor-pointer border-purple-500/30 hover:bg-purple-500/10 text-purple-400 font-bold"
            >
            ...
            <Button
              variant="outline"
              size="sm"
              onClick={() => router.push(`/marketplace?category=${event.category}`)}
              className="gap-2 flex-1 cursor-pointer border-blue-500/30 hover:bg-blue-500/10 text-blue-400 font-bold"
            >
            ...
            <Button
              ...
              disabled={isDeleting}
              className="text-red-500 hover:text-red-600 gap-2 cursor-pointer flex-1"
            >
        ...
        {stats.isEventToday && !stats.isEventPast && (
          <Button
            size="lg"
            // variant="outline"
            className="mb-8 w-full cursor-pointer gap-2 h-10 bg-linear-to-r from-orange-500 via-pink-500 to-red-500 text-white hover:scale-[1.02]"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4 ">
          <Card className="py-0 bg-purple-300">
          ...
          <Card className="py-0 bg-green-400">
            <CardContent className="p-6 flex items-center gap-3">
          ...
          {event.ticketType === "paid" ? (
            <Card className="py-0 bg-blue-400">
              <CardContent className="p-6 flex items-center gap-3">
            ...
            <Card className="py-0 bg-orange-400">
              <CardContent className="p-6 flex items-center gap-3">
          ...
          <Card className="py-0 bg-amber-300">
            <CardContent className="p-6 flex items-center gap-3">
