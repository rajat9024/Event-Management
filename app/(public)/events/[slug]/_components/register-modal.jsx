        ...
        <DialogContent className="sm:max-w-md bg-slate-900">
          <div className="flex flex-col items-center text-center space-y-4 py-6">
            ...
            <div className="w-full space-y-2">
              <Button className="w-full gap-2 bg-blue-500 hover:bg-blue-800 cursor-pointer" onClick={handleViewTicket}>
                <Ticket className="w-4 h-4" />
                View My Ticket
              </Button>
              <Button variant="secondary" className="w-full cursor-pointer" onClick={onClose}>
                Close
              </Button>
            </div>
          </div>
      ...
      <DialogContent className="sm:max-w-md border-muted-foreground
       bg-slate-900">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {/* Event Summary */}
          <div className=" p-4 rounded-lg space-y-2 bg-green-400">
          ...
          <div className="flex gap-2 pt-2 ">
            ...
            <Button type="submit" className="flex-1 gap-2 bg-blue-500 hover:bg-blue-800 cursor-pointer" disabled={isLoading}>
              {isLoading ? (
                <>
