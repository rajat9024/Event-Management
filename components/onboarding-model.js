...
export default function OnboardingModal({ isOpen, onClose, onComplete }) {
  ...
  return (
    ...
    //   <DialogContent className=" border-5 border-pink-500 sm:max-w-2xl bg-black text-white">
    //     <DialogHeader >
    //       <div className="mb-4">
    ...
    "
      >
        ...
        <DialogHeader className="shrink-0">
          <div className="mb-4 ">
            <Progress value={progress} className="h-1 bg-white/10 [&>div]:bg-gradient-to-r [&>div]:from-purple-500 [&>div]:to-pink-500" />
          </div>
