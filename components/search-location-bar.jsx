...
export default function SearchLocationBar() {
  ...
  return (
    <div className="flex items-center ">
      ...
      <div className="relative flex w-full" ref={searchRef}>
        <div className="flex-1">
          ...
          <Input
            ...
            className="pl-10 w-full h-9 rounded-none rounded-l-md border-muted-foreground"
          />
        </div>

        {/* Search Results */}
        {showSearchResults && (
          <div className="absolute top-full mt-2 w-96 bg-slate-900 border rounded-lg border-muted-foreground shadow-lg z-50 max-h-[400px] overflow-y-auto">
            {searchLoading ? (
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-3 text-xs text-muted-foreground hover:text-gray-900">
      ...
      >
        <SelectTrigger className="w-32 h-9 border-l-0 border-muted-foreground rounded-none">
      ...
      >
        <SelectTrigger className="w-32 h-9 rounded-none border-muted-foreground rounded-r-md">
